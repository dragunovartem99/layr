...
.layr__count { font-size: 12px; color: #c5c8c6; white-space: nowrap; flex-shrink: 0; }
.layr__btn {
  background: #282a2e;
  color: #969896;
  border: 1px solid #373b41;
...
.layr__order { color: #969896; font-size: 12px; min-width: 20px; text-align: right; flex-shrink: 0; }
.layr__event { flex: 1; color: #81a2be; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.layr__time { color: #969896; font-size: 12px; white-space: nowrap; flex-shrink: 0; }
